...
export function Sidebar() {
    ...
    const trialIdFromQuery = isTrialAssistantRoute
        ...
        : isDocumentAssistant
            ...
            : null;
    const { resetDemo, loadSampleData, loadFullDataset, getCurrentDataMode } =
        useDemoState();
                    ...
                    <div className="mt-6 border-t border-sidebar-border pt-4">
                        <div className="relative mb-2 h-7">
                            <div className="absolute inset-0 flex items-center justify-between">
                                ...
                                <button
                                    type="button"
                                    className={`h-7 w-7 inline-flex items-center justify-center rounded-md transition-colors ${chatHistorySearchOpen || chatHistorySearch.trim()
                            ...
                            <div
                                className={`absolute right-0 top-0 h-7 overflow-hidden transition-all duration-200 ease-out ${chatHistorySearchOpen ? "w-full opacity-100" : "w-0 opacity-0 pointer-events-none"
                                    }`}
                            >
                                            ...
                                            <div className="mt-1 space-y-1">
                                                {section.items.slice(0, normalizedSearch ? 20 : 4).map((chat) => (
                                                    <button
                                                        key={chat.id}
                                                        type="button"
                                                        className={`w-full flex items-start gap-2 py-1.5 pr-2 pl-3 rounded-md text-left transition-colors ${section.activeSessionId === chat.id
                                                            ? "bg-[#E6E7EB]"
                                                            : "hover:bg-[#E6E7EB]"
                                                            }`}
                                                        onClick={() => {
                            ...
                            <div className="border-t border-sidebar-border pt-4">
                                <div className="relative mb-2 h-7">
                                    <div className="absolute inset-0 flex items-center justify-between">
                                        ...
                                        <button
                                            type="button"
                                            className={`h-7 w-7 inline-flex items-center justify-center rounded-md transition-colors ${chatHistorySearchOpen || normalizedSearch
                                                ? "bg-blue-50 text-blue-600"
                                                : "text-muted-foreground hover:bg-gray-100"
                                                }`}
                                            onClick={() => {
                                        ...
                                        <>
                                            {chatHistoryPreview.length === 0 ? (
                                                ...
                                                chatHistoryPreview.map((chat) => (
                                                    <div
                                                        key={chat.id}
                                                        className={`group relative flex items-start gap-3 py-2 pr-8 pl-3 rounded-md cursor-pointer transition-colors ${activeChatSessionId === chat.id
                                                            ? "bg-[#E6E7EB]"
                                                            : "hover:bg-[#E6E7EB]"
                                                            }`}
                                                        onClick={() => {
                                                        ...
                                                        <div key={section.key}>
                                                            ...
                                                            <div className="mt-1 space-y-1">
                                                                {section.items.slice(0, normalizedSearch ? 20 : 4).map((chat) => (
                                                                    <div
                                                                        key={chat.id}
                                                                        className={`group relative w-full flex items-start gap-2 py-1.5 pr-8 pl-3 rounded-md text-left transition-colors cursor-pointer ${section.activeSessionId === chat.id
                                                                            ? "bg-[#E6E7EB]"
                                                                            : "hover:bg-[#E6E7EB]"
                                                                            }`}
                                                                        onClick={() => {
    ...
    return (
        <aside className={`fixed left-0 top-0 h-screen bg-white flex flex-col transition-all duration-300 z-10 ${isCollapsed ? "w-[64px]" : "w-[280px]"
            }`}>
            {/* Organization Header */}
