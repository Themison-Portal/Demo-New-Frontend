  ...
  if (variant === "messages") {
    return (
      <form onSubmit={submit} className="space-y-1 bg-white px-6 py-4">
        <div
          className="space-y-3 rounded-2xl bg-white px-4 pb-3 pt-3"
        ...
        >
          ...
          <div className="mt-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <button
                type="button"
                className="rounded-full bg-gray-100 p-1.5 text-gray-500 transition-colors duration-150 hover:bg-gray-200 hover:text-gray-700 focus:outline-none"
                aria-label="Attach"
              >
              ...
              <div ref={contextMenuRef} className="relative">
                <button
                  type="button"
                  className="inline-flex items-center gap-2 rounded-full bg-gray-100 px-3 py-1.5 text-sm text-gray-600 transition-colors duration-150 hover:bg-gray-200 focus:outline-none"
